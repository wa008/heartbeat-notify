...
@click.command()
@click.option('--config', '-c', type=click.Path(), default='~/.heartbeat-notify/config.yaml', help='Path to configuration YAML file. Default is ~/.heartbeat-notify/config.yaml.')
